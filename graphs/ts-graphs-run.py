...
folder_path = '/Users/samyak/SynologyDrive/George Mason University/Fall_2024/CS655/Final Project/human-activity-recognition/stream-files/Files/running/stream-running-8-2024-10-14_23-41-57'
...
for filename in os.listdir(folder_path):
    if filename.endswith(".csv"):
        ...
        if {'seconds_elapsed', 'x', 'y', 'z'}.issubset(data.columns):
            ...
            plt.ylabel('Readings')
            plt.title(f'Time-Series Graph of Running Data - {filename}')
            plt.legend()
