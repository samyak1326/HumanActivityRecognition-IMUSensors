...
folder_path = '/Users/samyak/SynologyDrive/George Mason University/Fall_2024/CS655/Final Project/human-activity-recognition/stream-files/Files/jumping/stream-jump-6-2024-10-16_13-14-28'
...
for filename in os.listdir(folder_path):
    if filename.endswith(".csv"):
        ...
        if {'seconds_elapsed', 'x', 'y', 'z'}.issubset(data.columns):
            ...
            plt.ylabel('Readings')
            plt.title(f'Time-Series Graph of Jumping Data - {filename}')
            plt.legend()
